    ...
    <View style={styles.container}>
      ...
      <View style={styles.menu}>
        <View style={styles.menu_item}>
          <TouchableOpacity style={[styles.btn_one, styles.btn]} onPress={() => navigation.navigate("SheduleDate")}>
        ...
        <View style={styles.menu_item}>
          <TouchableOpacity style={[styles.btn_two, styles.btn]}  onPress={() => navigation.navigate("UploadFile")}> 
      ...
      <View style={styles.menu}>
        <View style={styles.menu_item}>
          <TouchableOpacity style={[styles.btn_three, styles.btn]} onPress={() => navigation.navigate("GenerateCode")}>
            <Ionicons name="create-outline" size={20} color="#fff" />
            <Text style={styles.text}>Setting </Text>
          </TouchableOpacity>
        </View>
        <View style={styles.menu_item}>
          <TouchableOpacity style={[styles.btn_four, styles.btn]} onPress={() => navigation.navigate("SendMessage")}>
